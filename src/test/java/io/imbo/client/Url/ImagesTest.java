...
public class ImagesTest {
    ...
    public ImagesTest(String host, String publicKey, String expected) {
        this.host = host;
    ...
    public static List<Object[]> getUrlData() {
        return Arrays.asList(new Object[][] {
            { "http://imbo", "publicKey", "http://imbo/users/publicKey/images.json" },
            { "http://imbo:6081", "foobar", "http://imbo:6081/users/foobar/images.json" },
            { "https://imbo:6081/prefix", "foobar", "https://imbo:6081/prefix/users/foobar/images.json" }
        });
    }
